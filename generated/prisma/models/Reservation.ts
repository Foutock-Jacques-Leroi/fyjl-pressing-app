...
export type ReservationWhereInput = {
  ...
  trs_id?: Prisma.StringFilter<"Reservation"> | string
  ...
  c_id?: Prisma.StringFilter<"Reservation"> | string
...
export type ReservationScalarWhereWithAggregatesInput = {
  ...
  trs_id?: Prisma.StringWithAggregatesFilter<"Reservation"> | string
  ...
  c_id?: Prisma.StringWithAggregatesFilter<"Reservation"> | string
}
...
export type ReservationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"trs_id" | "status" | "notes" | "date" | "total_price" | "created_at" | "updated_at" | "c_id", ExtArgs["result"]["reservation"]>
...
export interface ReservationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `trs_id`
   * const reservationWithTrs_idOnly = await prisma.reservation.findMany({ select: { trs_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Reservations and only return the `trs_id`
   * const reservationWithTrs_idOnly = await prisma.reservation.createManyAndReturn({
   *   select: { trs_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Reservations and only return the `trs_id`
   * const reservationWithTrs_idOnly = await prisma.reservation.updateManyAndReturn({
   *   select: { trs_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ReservationFieldRefs {
  readonly trs_id: Prisma.FieldRef<"Reservation", 'String'>
  ...
  readonly c_id: Prisma.FieldRef<"Reservation", 'String'>
}
